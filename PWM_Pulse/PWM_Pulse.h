...
// #elif defined __AVR_ATmega2560__
	...
	void p1_constant_ramp50ms( uint32_t duration, unsigned long pre_trg_delay, int power);
	void p1_multipulses_ramp50ms(unsigned long duration, float fq, unsigned long p_width, unsigned long pre_trg_delay, int power);
	void p1_cancel(); 
	void p1_cancel_ramp50ms(); 
	...
	void p2_constant_ramp50ms( uint32_t duration, unsigned long pre_trg_delay, int power);
	void p2_multipulses_ramp50ms(unsigned long duration, float fq, unsigned long p_width, unsigned long pre_trg_delay, int power);
	void p2_cancel(); 
	void p2_cancel_ramp50ms(); 
	...
	void p3_constant_ramp50ms( uint32_t duration, unsigned long pre_trg_delay, int power);
	void p3_multipulses_ramp50ms(unsigned long duration, float fq, unsigned long p_width, unsigned long pre_trg_delay, int power);
	void p3_cancel(); 
	void p3_cancel_ramp50ms(); 
