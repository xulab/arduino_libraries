#ifndef _OLED_SSD1306_ADAFRUIT_S_SHOW_h
#define _OLED_SSD1306_ADAFRUIT_S_SHOW_h
#include "Arduino.h"

#define NOM_DIS 1
#define INVER_DIS 0

class OLED_Class_SSD1306_ADAFRUIT_S_SHOW
{
private:

public:
	//void Init(uint8_t cs, uint8_t dc, uint8_t reset, uint8_t rotation = false);
	void Init(uint8_t cs, uint8_t mosi, uint8_t clk, uint8_t dc, uint8_t reset, uint8_t rotation = false);
...
extern OLED_Class_SSD1306_ADAFRUIT_S_SHOW OLED_SSD1306;
#endif
